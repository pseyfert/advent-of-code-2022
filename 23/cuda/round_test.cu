...
TEST(example, rounds) {
  ...
  *rm4 = 0;
  ...
  for (std::size_t i = 0; i < *N_elves; ++i) {
    ...
    for (std::size_t j = 0; j < *N_elves; ++j) {
      if (h_x[j] == end_1.first[j] && h_y[j] == end_1.second[j]) {
        found = true;
        break;
      }
    }
  ...
  *rm4 = 1;
  ...
  for (std::size_t i = 0; i < *N_elves; ++i) {
    bool found = false;
    for (std::size_t j = 0; j < *N_elves; ++j) {
      if (h_x[j] == end_2.first[j] && h_y[j] == end_2.second[j]) {
        found = true;
        break;
      }
    }
  ...
  for (std::size_t i = 0; i < *N_elves; ++i) {
    bool found = false;
    for (std::size_t j = 0; j < *N_elves; ++j) {
      if (h_x[j] == end_5.first[j] && h_y[j] == end_5.second[j]) {
        found = true;
        break;
      }
    }
...
TEST(example, round10) {
  ...
  *rm4 = 0;
  ...
  for (std::size_t i = 0; i < *N_elves; ++i) {
    bool found = false;
    for (std::size_t j = 0; j < *N_elves; ++j) {
      if (h_x[j] == end_10.first[j] && h_y[j] == end_10.second[j]) {
        found = true;
        break;
      }
    }
